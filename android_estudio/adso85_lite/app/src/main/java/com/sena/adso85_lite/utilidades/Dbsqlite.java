...
public class Dbsqlite extends SQLiteOpenHelper {
    ...
    public ArrayList<CtrlUsuario> listarUsuario(){
        ArrayList<CtrlUsuario> usuarios = new ArrayList<CtrlUsuario>();
        SQLiteDatabase base = this.getWritableDatabase();

        String consulta = "SELECT id,login,contrasena,fec_creacion,estado,rol ";
        consulta        += "FROM usuarios ORDER BY id;";
